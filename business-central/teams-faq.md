...
2. Uw taal in [!INCLUDE [prod_short.md](includes/prod_short.md)], die u kunt zien in de [!INCLUDE [prod_short.md](includes/prod_short.md)] webclient (meer informatie vindt u in [Basisinstelling wijzigen - Taal](ui-change-basic-settings.md#language)).
...
Ontvang een lijst met ondersteunde talen voor [!INCLUDE [prod_short.md](includes/prod_short.md)] in [Ondersteunde talen](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations?toc=/dynamics365/business-central/toc.json#supported-languages).

### Werkt de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app met brancheoplossingen?

Ja. Maar alleen enkele functies van de app werken met Embed-apps:
...
Meer informatie over emdeb-apps vindt u in [Apps insluiten](/dynamics365/business-central/dev-itpro/deployment/embed-app-overview).

### Werkt [!INCLUDE [prod_short.md](includes/prod_short.md)] met de mobiele Teams-app?

Ja. De [!INCLUDE [prod_short.md](includes/prod_short.md)]-app kan worden geïnstalleerd vanuit de Teams-desktopapp of browser, of door een beheerder voor alle gebruikers. Eenmaal geïnstalleerd is de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app automatisch beschikbaar in Teams voor iOS en Android. Op mobiele apparaten kunt u alleen kaarten bekijken die door anderen zijn verzonden, toegang krijgen tot details of de kaart eruit laten springen voor de volledige ervaring in de mobiele [!INCLUDE [prod_short.md](includes/prod_short.md)]-app. U kunt bij het opstellen van berichten of het zoeken naar contacten geen koppelingen plakken die tot kaarten worden uitgevouwen. Meer informatie over de minimumvereisten voor mobiel vindt u in [Minimumvereisten voor het gebruik van Business Central](product-requirements.md).
...
Meer informatie over de minimumvereisten vindt u in [Minimumvereisten voor het gebruik van Business Central](product-requirements.md#teams).

Meer informatie over de keuze van Teams-clients en hoe u deze installeert, vindt u in [Clients ophalen voor Microsoft Teams](/microsoftteams/get-clients) in de Teams-documentatie.
...
U kunt lijstpagina's toevoegen aan de aanbevolen inhoud door bladwijzers toe te voegen. U kunt aanbevolen inhoud ook verwijderen door bladwijzers te verwijderen. Meer informatie vindt u in [Een pagina of rapport als bladwijzer toevoegen in uw rolcentrum](ui-bookmarks.md).
...
Ja. Zoeken naar contacten vanuit Teams is gebaseerd op [!INCLUDE [prod_short.md](includes/prod_short.md)] v2.0-API's en onderhevig aan eventuele API-limieten die het gebruik beheren. Meer informatie over de limieten vindt u in [Huidige API-limieten](/dynamics-nav/api-reference/v2.0/dynamics-current-limits).
