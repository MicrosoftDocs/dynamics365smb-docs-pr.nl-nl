...
1. Kies het pictogram ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), Pictogram, voer  **Terugkerende algemene dagboeken** in en kies vervolgens de gerelateerde koppelen.
...
5. Wanneer je Gereed, Sluiten de pagina. Er wordt een nieuw, leeg periodiek dagboek geopend.
6. Vul de velden op de regel in.
7. Kies de actie **Verdeelsleutels**.
8. Voeg voor elke verdeelsleutel een regel toe. U moet ofwel het veld **Verdeelsleutel %**, of **Verdeelsleutelaantal**, of **Bedrag** invullen. U moet ook het veld  **Rekeningnummer**  invullen en, als u de transactie toewijst aan globale dimensies, de velden globale dimensie.
...
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), Pictogram, voer  **Terugkerende algemene dagboeken** in en kies vervolgens de gerelateerde koppelen.
2. Selecteer op de pagina  **Terugkerende dagboeken** het dagboek met de toewijzing.
