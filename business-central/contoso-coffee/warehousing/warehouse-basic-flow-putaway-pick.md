...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-basic-warehouse-configurations" />Procedure van de inkomende en uitgaande stroom in standaardmagazijnconfiguraties
...
## <a name="outbound-flow-picking-and-shipping-in-basic-warehouse-configurations" />Uitgaande stroom: picken en verzenden in standaardmagazijnconfiguraties
