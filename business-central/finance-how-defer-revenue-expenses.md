...
4. Geef in het veld **Berekeningsmethode** op hoe het veld **Bedrag** voor elke periode op de pagina **Uitstelschema** wordt berekend. U hebt de volgende mogelijkheden:
   ...
   * **Gelijk per periode**: De periodieke uitstelbedragen worden berekend op basis van het aantal perioden en gelijkmatig verdeeld over de perioden.
   * **Dagen per periode**: De periodieke uitstelbedragen worden berekend op basis van het aantal dagen in de periode.
   * **Door de gebruiker gedefinieerd**: De periodieke uitstelbedragen worden niet berekend. U moet het veld **Bedrag** handmatig invullen voor elke periode op de pagina Uitstelschema. Zie voor meer informatie het gedeelte "Een uitstelschema wijzigen vanuit een verkoopfactuur".
...
3. Selecteer op het sneltabblad  **kosten en boekingen** in het veld  **Standaard uitstel sjabloon** de relevante uitstel sjabloon.
