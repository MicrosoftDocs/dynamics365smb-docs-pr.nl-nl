...
ms.locfileid: "8518308"
---
# <a name="set-up-a-company-with-rapidstart-services"></a>Een bedrijf instellen met RapidStart Services
...
Gebruik deze mogelijkheden om uw bedrijf als reseller op te schalen. De meeste relevante pagina's zijn van toepassing op zowel [!INCLUDE [prod_short](includes/prod_short.md)] online als on-premises. Sommige processen zijn echter afhankelijk van toegang tot bestanden op schijf en zijn te complex om door [!INCLUDE [prod_short](includes/prod_short.md)] online te worden gebruikt. Voor [!INCLUDE [prod_short](includes/prod_short.md)] on-premises kunt u waarschijnlijk het beste Windows PowerShell gebruiken om u te helpen bij de implementatie. Zie respectievelijk [Beheer van Business Central On-Premises](/dynamics365/business-central/dev-itpro/administration/administration) en [Beheer van Business Central Online](/dynamics365/business-central/dev-itpro/administration/tenant-administration) voor meer informatie.  
...
|Bereid u voor om bedrijfsconfiguraties in andere bedrijven opnieuw te gebruiken (in de inhoud voor ontwikkelaars en beheerders).|[Aangepaste configuratiepakketten voor bedrijven maken](/dynamics365/business-central/dev-itpro/administration/set-up-standard-company-configuration-packages)|
