...
2. Open de **G/L Account kaart** voor de rekening.  
...
3. Kies de **btw-bus.-boekingsgroep**.  
...
2. Ga op een van de volgende manieren te werk:  
    ...
    * Vouw op het tabblad  **Artikel** kaart het sneltabblad  **Prijs en boeking**  uit en kies vervolgens  **Meer weergeven** om het veld  **btw-productboekingsgroep**  weer te geven.  
...
2. Selecteer in de kolom  **btw-clausule Code** de clausule die u wilt gebruiken voor elke btw-boekingsinstelling waarop deze van toepassing is.  
...
[btw-aangiftesjablonen en btw-aangiftenamen instellen](finance-how-setup-vat-statement.md)    
...
[Controleer btw-registratienummers](finance-how-validate-vat-registration-number.md)    
...
[Goederen- en dienstenbelastingboeking instellen in de Australische versie](LocalFunctionality/Australia/how-to-set-up-goods-and-service-tax-posting.md)    
