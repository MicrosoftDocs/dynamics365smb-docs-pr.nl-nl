---
title: Kostenposten overdragen en boeken
...
# <a name="transferring-and-posting-cost-entries"></a>Kostenposten overdragen en boeken
...
## <a name="criteria-for-transferring-general-ledger-entries-to-cost-entries"></a>Criteria voor het overdragen van grootboek-posten naar kostenposten

Het is belangrijk om de criteria voor het overdragen van grootboek-posten naar kostenposten te begrijpen. Tijdens de overdracht maakt de batchverwerking **Grootboekposten overbrengen naar kostprijsboekhouding** gebruik van de volgende criteria om te bepalen of en hoe de grootboekposten worden overgebracht.  
...
grootboek-items worden niet overgedragen als:  

- De vermeldingen hebben dimensiewaarden die niet overeenkomen met een kostenplaats of een kostenobject.  
- De posten bevatten een bedrag met waarde nul.  
- De posten zijn van een grootboekrekening die is verwijderd.  
- De posten hebben een rekening grootboek die niet van het type  **Winst- en verliesrekening is**.  
- De boekingen hebben een rekening grootboek waaraan geen kostentype is toegewezen.  
...
## <a name="transferring-general-ledger-entries-to-cost-entries"></a>grootboek-posten overzetten naar kostenposten
...
2.  Klik op **Ja** om de overdracht te starten. Het proces draagt alle grootboek-vermeldingen over die nog niet zijn overgedragen.  
...
## <a name="automatic-transfer-and-combined-entries"></a>Automatische overdracht en gecombineerde boekingen
...
## <a name="results-of-transferring-general-ledger-entries-to-cost-entries"></a>Resultaten van het overbrengen van grootboek-posten naar kostenposten
...
In de tabel **Kostenregister**, wordt door [!INCLUDE[prod_short](includes/prod_short.md)] een post gemaakt met de bronoverdracht van het grootboek. In deze boeking worden de eerste en laatste boekingsnummers vastgelegd van de grootboek-boekingen die worden overgedragen, naast de eerste en laatste boekingsnummers van de kostenboekingen die worden aangemaakt.
