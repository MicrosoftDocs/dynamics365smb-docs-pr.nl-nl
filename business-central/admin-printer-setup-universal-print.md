...
5. Deel de printers met gebruikers.
    ...
    > [!TIP]
    > U kunt later altijd gebruikers toevoegen of verwijderen. Meer informatie vindt u op [Configureer gebruikersmachtigingen voor printer Delen](/universal-print/reference/portal/share-printers#configure-user-permissions-for-a-printer-share).
...
6. Documentconversie inschakelen.
    ...
    Meer informatie vindt u op  [Overzicht documentconversie](/universal-print/reference/portal/settings#2-document-conversion).
