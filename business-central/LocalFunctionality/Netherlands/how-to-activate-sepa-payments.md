...
ms.author: edupont
---
# <a name="activate-sepa-payments-in-the-dutch-version" />SEPA-betalingen activeren in de Nederlandse versie

[!INCLUDE [activate-sepa-payments](../includes/BENL/activate-sepa-payments.md)]

## <a name="to-enable-transaction-modes-for-sepa" />Transactiewijzen activeren voor SEPA
...
## <a name="to-verify-vendor-payment-transaction-modes-for-sepa" />Transactiewijzen voor leveranciersbetalingen voor SEPA verifiëren
