...
ms.author: edupont
---
# <a name="payment-scenario-2---foreign-payment-fcy-to-fcy-in-the-dutch-version"></a><a name="payment-scenario-2---foreign-payment-fcy-to-fcy-in-the-dutch-version"></a><a name="payment-scenario-2---foreign-payment-fcy-to-fcy-in-the-dutch-version"></a>Betalingsscenario 2 - Buitenlandse betaling (VV naar VV) in de Nederlandse versie
...
## <a name="create-vendorcustomer"></a><a name="create-vendorcustomer"></a><a name="create-vendorcustomer"></a>Leverancier/klant maken
...
## <a name="create-vendorcustomer-bank-account"></a><a name="create-vendorcustomer-bank-account"></a><a name="create-vendorcustomer-bank-account"></a>Bankrekening leverancier/klant maken
...
## <a name="create-and-post-purchase-invoice-for-vendor-or-sales-invoice-for-customer"></a><a name="create-and-post-purchase-invoice-for-vendor-or-sales-invoice-for-customer"></a><a name="create-and-post-purchase-invoice-for-vendor-or-sales-invoice-for-customer"></a>Inkoopfactuur voor leverancier of verkoopfactuur voor klant maken en boeken
...
### <a name="example-2"></a><a name="example-2"></a><a name="example-2"></a>Voorbeeld
...
## <a name="create-proposal"></a><a name="create-proposal"></a><a name="create-proposal"></a>Voorstel maken
...
### <a name="example-3"></a><a name="example-3"></a><a name="example-3"></a>Opmerking
...
## <a name="create-payment-history"></a><a name="create-payment-history"></a><a name="create-payment-history"></a>Betaalrun maken
...
### <a name="example-4"></a><a name="example-4"></a><a name="example-4"></a>Opmerking
...
## <a name="export-payment-history"></a><a name="export-payment-history"></a><a name="export-payment-history"></a>Betaalrun exporteren
...
### <a name="example-5"></a><a name="example-5"></a><a name="example-5"></a>Voorbeeld
Aangezien de transactiewijze die aan onze betaling is gekoppeld ABN-USD is, verschijnt de batchverwerking **BBV** of **PAYMUL**.  

## <a name="import-bank-statement"></a><a name="import-bank-statement"></a><a name="import-bank-statement"></a>Bankafschrift importeren
...
### <a name="example-6"></a><a name="example-6"></a><a name="example-6"></a>Opmerking
