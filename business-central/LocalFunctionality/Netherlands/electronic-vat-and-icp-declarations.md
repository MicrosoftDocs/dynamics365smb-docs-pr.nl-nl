...
ms.author: edupont
---
# <a name="submitting-electronic-vat-and-icp-declarations-in-the-dutch-version"></a><a name="submitting-electronic-vat-and-icp-declarations-in-the-dutch-version"></a>Elektronische btw- en ICP-aangiften verzenden in de Nederlandse versie
...
## <a name="to-prepare-for-electronic-declaration"></a><a name="to-prepare-for-electronic-declaration"></a>Elektronische aangifte voorbereiden
...
## <a name="to-create-an-electronic-declaration"></a><a name="to-create-an-electronic-declaration"></a>Een elektronische aangifte aanmaken
...
## <a name="to-submit-an-electronic-declaration"></a><a name="to-submit-an-electronic-declaration"></a>Een elektronische aangifte versturen
...
## <a name="to-import-a-response-message-from-the-tax-authorities"></a><a name="to-import-a-response-message-from-the-tax-authorities"></a>Een responsbericht van de belastingdienst importeren
...
## <a name="to-process-a-response-message-from-the-tax-authorities"></a><a name="to-process-a-response-message-from-the-tax-authorities"></a>Een responsbericht van de belastingdienst verwerken
