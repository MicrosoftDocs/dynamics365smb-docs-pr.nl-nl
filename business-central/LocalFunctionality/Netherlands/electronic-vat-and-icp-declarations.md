...
Een transactie komt alleen in aanmerking voor ICP-aangifte als de handelswaar de grens fysiek heeft overschreden. Het is niet voldoende dat de locatie van een factuuradres of het kantoor van de leverancier of klant in een ander EU-land/regio ligt.  

U kunt de btw-aangiften en ICP-aangiften als volgt verzenden:  

- Meld u aan op de website van het Nederlandse belastingkantoor en voer de informatie handmatig in. Voor meer informatie kunt u terecht op de website van de Belastingdienst. [...](https://www.belastingdienst.nl/wps/wcm/connect/en/individuals/individuals)  
...
1. Controleer of u de certificaten van de overheid ontvangt. Als dat niet zo is, voert u de volgende stappen uit om de certificaten te krijgen:
    ...
    - Registreer een gebruiker van Digipoort, dit kan hier Gereed zijn: [https://aansluiten.procesinfrastructuur.nl/site/registratienieuw](https://aansluiten.procesinfrastructuur.nl/site/registratienieuw).
