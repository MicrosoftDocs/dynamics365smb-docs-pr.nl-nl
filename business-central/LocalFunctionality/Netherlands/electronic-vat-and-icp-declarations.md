...
ms.author: edupont
---
# <a name="submitting-electronic-vat-and-icp-declarations-in-the-dutch-version" />Elektronische btw- en ICP-aangiften verzenden in de Nederlandse versie
...
## <a name="to-prepare-for-electronic-declaration" />Elektronische aangifte voorbereiden
...
## <a name="to-create-an-electronic-declaration" />Een elektronische aangifte aanmaken
...
## <a name="to-submit-an-electronic-declaration" />Een elektronische aangifte versturen
...
## <a name="to-import-a-response-message-from-the-tax-authorities" />Een responsbericht van de belastingdienst importeren
...
## <a name="to-process-a-response-message-from-the-tax-authorities" />Een responsbericht van de belastingdienst verwerken
