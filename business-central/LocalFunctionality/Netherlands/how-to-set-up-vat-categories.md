...
ms.author: edupont
---
# <a name="set-up-vat-categories"></a><a name="set-up-vat-categories"></a><a name="set-up-vat-categories"></a>VAT-categorieën instellen
...
## <a name="to-set-up-a-vat-category"></a><a name="to-set-up-a-vat-category"></a><a name="to-set-up-a-vat-category"></a>Een btw-categorie instellen
