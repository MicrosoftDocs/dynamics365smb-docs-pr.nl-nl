...
ms.author: edupont
---
# <a name="dutch-electronic-banking" />Elektronisch bankieren voor Nederland
...
## <a name="telebanking" />Telebankieren
...
### <a name="payment-files" />Betalingsbestanden
...
### <a name="direct-debit-files" />Bestanden voor automatische incasso
...
### <a name="bank-statement-import" />Importeren van bankafschriften
