...
ms.author: edupont
---
# <a name="create-an-audit-file-for-the-tax-authority-in-the-dutch-version" />Een auditfile voor de Belastingdienst maken in de Nederlandse versie
...
## <a name="to-make-an-audit-file" />Een auditfile maken
