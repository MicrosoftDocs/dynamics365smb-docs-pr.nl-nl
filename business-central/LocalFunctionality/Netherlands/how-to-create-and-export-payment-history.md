...
ms.author: edupont
---
# <a name="create-and-export-payment-history-in-the-dutch-version" />Maak en exporteer betalingsgeschiedenis in de Nederlandse versie
...
## <a name="to-create-a-payment-history-for-a-proposal" />Een betaalrun voor een voorstel maken
...
## <a name="to-export-a-payment-history" />Een betaalrun exporteren
