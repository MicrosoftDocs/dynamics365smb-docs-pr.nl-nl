...
ms.author: edupont
---
# <a name="create-proposals"></a><a name="create-proposals"></a><a name="create-proposals"></a>Voorstellen maken
...
## <a name="to-create-proposals-manually"></a><a name="to-create-proposals-manually"></a><a name="to-create-proposals-manually"></a>Handmatig voorstellen maken
...
## <a name="to-create-proposals-automatically-from-sales"></a><a name="to-create-proposals-automatically-from-sales"></a><a name="to-create-proposals-automatically-from-sales"></a>Automatisch voorstellen maken op basis van verkoop
...
## <a name="to-create-proposals-automatically-from-purchases"></a><a name="to-create-proposals-automatically-from-purchases"></a><a name="to-create-proposals-automatically-from-purchases"></a>Automatisch voorstellen maken op basis van inkoop
