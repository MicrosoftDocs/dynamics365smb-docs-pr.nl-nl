...
# <a name="setting-up-electronic-vat-and-icp-declarations-in-the-dutch-version"></a><a name="setting-up-electronic-vat-and-icp-declarations-in-the-dutch-version"></a><a name="setting-up-electronic-vat-and-icp-declarations-in-the-dutch-version"></a>Elektronische btw- en ICP-aangiften instellen in de Nederlandse versie
...
## <a name="to-set-up-electronic-declarations"></a><a name="to-set-up-electronic-declarations"></a><a name="to-set-up-electronic-declarations"></a>Elektronische aangiften instellen
