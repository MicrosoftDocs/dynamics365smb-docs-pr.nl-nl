---
title: Problemen oplossen en afmetingen corrigeren
...
# <a name="troubleshoot-and-correct-dimensions"></a>Problemen oplossen en afmetingen corrigeren
...
1. Gebruik een van de volgende pagina's om een dimensiecorrectie te starten:
    ...
    * Op de pagina  **G/L Registers** selecteert u een register en kiest u vervolgens de actie  **Corrigeer afmetingen** . Deze actie start een correctie voor de posten in het geselecteerde register.
    * Op de pagina **grootboek Entries** kunt u de actie **Correct Dimensions** kiezen. 
...
5. Kies om de correctie te valideren **Dimensiewijzigingen valideren**. Zie  [Dimensiecorrecties valideren](finance-troubleshooting-correcting-dimensions.md#validate-dimension-corrections) voor meer informatie.
6. Kies **Uitvoeren**.

### <a name="validate-dimension-corrections"></a>Valideer dimensiecorrecties
...
### <a name="view-historical-dimension-corrections"></a>Bekijk historische dimensiecorrecties

Als een grootboekpost is gecorrigeerd, kunt u de wijziging onderzoeken met de actie **Historie van dimensiecorrecties**.

### <a name="handle-incomplete-corrections"></a>Onvolledige correcties verwerken
