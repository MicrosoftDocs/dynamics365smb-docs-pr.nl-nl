...
Voordat u uw bankrekeningen binnen  [!INCLUDE[prod_short](includes/prod_short.md)] kunt beheren, moet u elke bankrekening instellen als bankrekening kaart. Daarnaast moet u elektronische services instellen die u kunt gebruiken voor de import van bankafschriften en de export van het betalingsbestand. Zie [Bankieren instellen](bank-setup-banking.md) voor meer informatie.
