...
## <a name="navigation" /><a name="navigation"></a><a name="Navigation"></a> Navigatie
...
## <a name="headings-in-content" /><a name="headings-in-content"></a><a name="Headings"></a> Koppen in inhoud
...
## <a name="image-and-links" /><a name="image-and-links"></a><a name="Images"></a> Afbeelding en koppelingen
...
## <a name="assistive-technologies" /><a name="assistive-technologies"></a><a name="AssistiveTech"></a> Ondersteunende technologieën
...
## <a name="zoom" /><a name="zoom"></a><a name="zoom"></a> In-/uitzoomen
