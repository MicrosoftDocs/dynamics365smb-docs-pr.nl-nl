...
# <a name="synchronize-and-fulfill-sales-orders" />Verkooporders synchroniseren en uitvoeren
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card" />De import van orders instellen op de Shopify-winkelkaart
...
### <a name="shipment-method-mapping" />Toewijzing van verzendwijzen
...
### <a name="location-mapping" />Locatietoewijzing
...
## <a name="run-the-order-synchronization" />De ordersynchronisatie uitvoeren
...
## <a name="review-imported-orders" />Geïmporteerde bestellingen bekijken
...
## <a name="create-sales-documents-in-business-central" />Verkoopdocument maken in Business Central
...
### <a name="to-create-sales-documents" />Verkoopdocumenten maken
...
### <a name="manage-missing-customers" />Ontbrekende klanten beheren
...
### <a name="how-the-connector-chooses-which-customer-to-use" />Hoe de connector kiest welke klant te gebruiken
...
### <a name="different-processing-rules-for-orders" />Verschillende verwerkingsregels voor orders
...
### <a name="impact-of-order-editing" />Impact van bewerkingen van orders
...
## <a name="synchronize-shipments-to-shopify" />Verzendingen synchroniseren met Shopify
...
### <a name="shipping-agents-and-tracking-url" />Expediteurs en tracerings-URL
...
## <a name="returns-and-refunds" />Retouren en terugbetalingen
...
## <a name="gift-cards" />Geschenkbonnen
