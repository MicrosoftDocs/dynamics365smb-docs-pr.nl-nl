...
description: Meer informatie over hoe u zich snel kunt registreren voor een gratis proefversie van Dynamics 365 Business Central. Verken de app met rondleidingen en video's, en vind extra trainingsmateriaal.
author: edupont04
...
Het laden van de proefversie duurt enkele ogenblikken. Vervolgens kunt u aan de slag gaan met de app.

## <a name="what-to-try"></a>Wat uit te proberen

Uw proefomgeving bevat veel van dezelfde functies als de betaalde versie. De volgende koppelingen helpen u met enkele van de belangrijkste functies.

- [Meer informatie over functies van Business Central](across-business-functionality.md)  
