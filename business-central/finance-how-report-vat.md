...
description: 'Leer hoe u rapporten opstelt waarin de btw over verkopen in een bepaalde periode, of over verkopen en aankopen, wordt vermeld en hoe u deze rapporten indient bij de belastingdienst.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
# <a name="report-vat-to-tax-authorities"></a>Btw melden aan de belastingdienst

In dit artikel worden de rapporten beschreven die u kunt gebruiken om informatie over btw-bedragen voor verkopen en aankopen in te dienen bij de belastingdienst in uw regio. [!INCLUDE[prod_short](includes/prod_short.md)]  Afhankelijk van het specifieke land/de specifieke regio kunnen de rapporten specifieke informatie bevatten of moet u mogelijk aanvullende rapporten indienen. Bekijk de artikelen voor uw land/regio in de sectie [Lokale functionaliteit](about-localization.md).  
...
Nadat de belastingdienst uw aangifte heeft beoordeeld, sturen zij een e-mail naar de contactpersoon van uw bedrijf. In [!INCLUDE[prod_short](includes/prod_short.md)] wordt de contactpersoon opgegeven op de pagina **Bedrijfsgegevens**. Voordat u de lijst verzendt, moet u ervoor zorgen dat een contact is geselecteerd.  
...
Als uw bedrijf niet in het Verenigd Koninkrijk is gevestigd, kunt u de pagina  **btw-aangifteperioden**  gebruiken om geplande btw-aangiften in te stellen. Als uw bedrijf in het Verenigd Koninkrijk is gevestigd, lees dan  [Making Tax Digital in het Verenigd Koninkrijk](LocalFunctionality/UnitedKingdom/making-tax-digital-submit-vat-return.md).  
...
1. Kies het pictogram ![Lampje dat de functie Vertel me 3 opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), Pictogram, voer  **EG-verkooplijst** of **btw-aangiften** in en kies vervolgens de gerelateerde koppelen.  
...
| Afgewezen | Als uw indiening niet succesvol is (bijvoorbeeld omdat de authenticatie is mislukt), verandert de status in  **Afgewezen**. U kunt een btw-aangifte met deze status niet opnieuw openen. |
...
| Geaccepteerd | De btw-aangifte heeft deze status als het rapport is gemarkeerd als geaccepteerd met behulp van de actie  **Markeren als geaccepteerd** . Als het rapport **Btw-aangifte** is gemarkeerd als **Geaccepteerd**, kunt u de actie **Btw-vereffening berekenen en boeken** uitvoeren. |
...
[Berekeningen en boekingsmethoden voor omzetbelasting instellen](finance-setup-vat.md)    
[Werken met btw op verkoop en inkoop](finance-work-with-vat.md)    
[Verkoop opzetten](sales-setup-sales.md)    
