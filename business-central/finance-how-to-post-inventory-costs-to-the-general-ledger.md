---
title: Verzoen voorraadkosten met de grootboek
...
# <a name="reconcile-inventory-costs-with-the-general-ledger"></a>Verzoen voorraadkosten met de grootboek
...
2. Voorraadkosten handmatig naar het grootboek boeken door de batchverwerking. Als u deze batchverwerking uitvoert, worden grootboekposten op basis van de waardeposten gemaakt. U kunt de berichten zo plaatsen dat ze per berichtengroep worden samengevat.
...
Als u een overzicht wilt krijgen van welke waarden naar grootboek kunnen worden geboekt zonder de boeking daadwerkelijk uit te voeren, kunt u de batchtaak  **Voorraadkosten naar grootboek boeken**  uitvoeren zonder de waarden daadwerkelijk naar grootboek te boeken. U doet dit door het selectievakje **Boeken** in het aanvraagvenster uit te schakelen. Op deze manier wordt er bij het uitvoeren van de batchtaak een rapport gegenereerd met de waarden die klaar zijn om naar grootboek te worden geboekt. Ze worden echter niet geboekt.
...
- Geeft niet-afgestemde kostenbedragen weer in de waardeposten in het voorraadboek, alsof ze zijn toegewezen aan overeenkomstige voorraadgerelateerde rekeningen in het grootboek. Vervolgens worden deze vergeleken met de totalen die in dezelfde rekeningen in het grootboek zijn vastgelegd.
...
In de kolommen **Voorraad**, **Voorraad (interim)** en **OHW-voorraad** staan de gefactureerde, niet gefactureerde en OHW-totalen van elke grootboekrekeningsoort. Deze worden berekend op basis van waardeposten, dat wil zeggen dat ze worden geprojecteerd op de grootboekrekeningtypen waar ze eindigen wanneer ze uiteindelijk in het grootboek worden geboekt.
