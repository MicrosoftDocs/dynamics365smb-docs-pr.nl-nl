...
4. Wijs de velden uit het XML-bestand toe aan de tabel met wisselkoersen in het bronveld.
5. Pas eventuele noodzakelijke transformatieregels toe.
6. Zet de schakelaar **Ingeschakeld** aan om de service in te schakelen.
...
Zo nu en dan moet u mogelijk een fout corrigeren in een betalingstransactie die gepaard gaat met aanpassingen aan winsten en verliezen in vreemde valuta's. U kunt de actie  **transactie omkeren** op de pagina's  **Bankrekeningposten**,  **Klantposten** en  **Leveranciersposten**  gebruiken om de betalingstransactie ongedaan te maken en terug te draaien.
