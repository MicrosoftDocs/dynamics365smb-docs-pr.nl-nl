---
title: Kostprijsboekhouding instellen
...
# <a name="set-up-cost-accounting"></a>Kostprijsboekhouding instellen

Voordat u begint te werken met kostprijsboekhouding, moet u insteltaken uitvoeren.

## <a name="balances-between-cost-type-cost-center-and-cost-object"></a>Balans tussen kostensoort, kostenplaats en kostenobject
...
## <a name="set-up-cost-types"></a>Kostentypen instellen
...
U kunt de actie  **kostenboekhouddimensies bijwerken** kiezen om de kostenboekhouddimensies bij te werken.
...
> [!NOTE]  
>  Om er zeker van te zijn dat de vooraf gedefinieerde kostenplaats en het kostenobject die u instelt in grootboek automatisch worden overgedragen naar de kostprijsberekening, selecteert u het selectievakje  **G/L-boekingen controleren**  op de pagina  **kostenberekening instellen** .
