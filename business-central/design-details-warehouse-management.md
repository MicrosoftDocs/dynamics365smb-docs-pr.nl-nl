...
|Basis|Order-voor-order.|Aankoop, verkoop, service en overdracht: vereisen opslag of vereisen picken. </br><br/> Productie, Assemblage, projecten: Voorraadverzameling, Voorraadverplaatsing, Voorraadopslag </br></br>**OPMERKING**: U kunt nog steeds ontvangsten, verzendingen, verbruiken en uitvoer rechtstreeks vanuit de brondocumenten boeken op de locaties waar u deze instellingen hebt geactiveerd.|Optioneel. Bepaald door de instelling **Opslaglocatiecode is verplicht**.|Inkooporder - Voorraadopslag|Verkooporder -> Voorraadpick|Productieorder - Voorraadpick|
|Geavanceerd|Geconsolideerde boeking voor ontvangen/verzenden voor meerdere orders.<br /><br />Geconsolideerde pick-/opslagactiviteiten voor meerdere brondocumenten.|Aankoop, verkoop, service en overdracht: vereisen ontvangst + vereisen opslag,</br> Verzending vereist + Pick vereist</br></br> Productie, Assemblage, projecten: Magazijn Pick |Optioneel. Bepaald door de instelling Opslaglocatiecode is verplicht|Inkooporder(s) -> Magazijnontvangst -> Magazijnopslag|Verkooporder(s) -> Magazijnzending(en) -> Pickvoorstel -> Magazijnpick(s)| Productieorder -> Pickvoorstel -> Magazijnpick(s) -> Verbruiksdagboek|
...
Meer informatie vindt u op [Activeer het picken van artikelen door FEFO](warehouse-picking-by-fefo.md).
