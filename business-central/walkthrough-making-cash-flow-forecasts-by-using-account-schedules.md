---
title: Maak kasstroomprognoses met behulp van financiële rapporten
...
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Walkthrough: Maak kasstroomprognoses met behulp van financiële rapporten
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Wijs de kolomdefinitie toe aan de naam van het financiële rapport
