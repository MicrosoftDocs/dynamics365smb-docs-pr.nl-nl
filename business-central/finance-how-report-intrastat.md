...
---
# <a name="work-with-intrastat-reporting" /><a name="work-with-intrastat-reporting"></a>Werken met Intrastat-rapportage
...
## <a name="fill-in-the-intrastat-report" /><a name="fill-in-the-intrastat-report"></a>Het Intrastat-rapport invullen
...
## <a name="modify-the-intrastat-report" /><a name="modify-the-intrastat-report"></a>Het Intrastat-rapport wijzigen
...
## <a name="validate-intrastat-lines" /><a name="validate-intrastat-lines"></a>Intrastat-regels valideren
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure" /><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Gewicht of aanvullende maateenheid herberekenen
...
## <a name="report-intrastat-in-a-file" /><a name="report-intrastat-in-a-file"></a>Intrastat in een bestand rapporteren
...
## <a name="intrastat-rules" /><a name="intrastat-rules"></a>Intrastat-regels

### <a name="grouping-lines" /><a name="grouping-lines"></a>Regels groeperen
...
### <a name="fixed-assets-reporting" /><a name="fixed-assets-reporting"></a>Vaste activa rapporteren
...
### <a name="intrastat-report-statuses" /><a name="intrastat-report-statuses"></a>Intrastat-rapportstatussen
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesprocess-intrastat-dynamics-365-business-centralindex" /><a name="see-related-training-at-microsoft-learn"></a>Zie gerelateerde training op [Microsoft Learn](/learn/modules/process-intrastat-dynamics-365-business-central/index).
