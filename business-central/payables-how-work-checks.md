...
---
# <a name="make-check-payments" /><a name="make-check-payments"></a>Chequebetalingen doen
...
## <a name="to-pay-a-vendor-invoice-with-a-computer-check" /><a name="to-pay-a-vendor-invoice-with-a-computer-check"></a>Een leverancier betalen met een automatische cheque
...
## <a name="to-cancel-printed-checks-that-are-not-posted" /><a name="to-cancel-printed-checks-that-are-not-posted"></a>Afgedrukte cheques annuleren die niet zijn geboekt
...
## <a name="to-void-checks" /><a name="to-void-checks"></a>Cheques nietig verklaren
...
## <a name="to-view-a-summary-of-posted-checks" /><a name="to-view-a-summary-of-posted-checks"></a>Een overzicht weergeven van geboekte cheques
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-checks-dynamics-365-business-central" /><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/use-checks-dynamics-365-business-central/)
