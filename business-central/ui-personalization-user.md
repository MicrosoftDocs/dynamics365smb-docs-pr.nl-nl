...
> [!NOTE]
> Beheerders kunnen dezelfde indeling-wijzigingen doorvoeren als gebruikers door een profiel (rol) aan te passen. Deze kan aan meerdere gebruikers worden toegewezen. Ga voor meer informatie over pagina's voor rollen naar [Pagina's aanpassen voor rollen](ui-personalization-manage.md)<br /><br />
...
## <a name="video-and-training"></a>Video en training

De volgende video toont enkele manieren waarop u uw rolcentrum kunt personaliseren.

> [!Video https://www.microsoft.com/en-us/videoplayer/embed/RE4ArUB?rel=0]

Ga voor online training naar  [Personaliseer de Microsoft-gebruikersinterface Dynamics 365 Business Central](/training/modules/personalize-ui-dynamics-365-business-central/).
