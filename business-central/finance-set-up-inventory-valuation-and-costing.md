---
title: Voorraadwaardering en -kosten opstellen
...
|Zorg ervoor dat de verwachte kosten worden geboekt in grootboek, zodat u op basis van de tussentijdse grootboekrekeningen een schatting kunt maken van de verschuldigde bedragen en de kosten van de verhandelde artikelen voordat deze worden gefactureerd.|Het veld **Verw. kostprijs naar GB boeken** op de pagina **Voorraadinstelling**|  
...
[Ontwerpdetails: inventariskosten](design-details-inventory-costing.md)    
[Ontwerpdetails: Wijzig de kostprijsberekeningsmethode voor artikelen](design-details-changing-costing-methods.md)    
