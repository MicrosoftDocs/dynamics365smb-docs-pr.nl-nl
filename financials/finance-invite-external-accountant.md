...
---
# <a name="invite-your-external-accountant-to-your-included365finincludesd365finmdmd"></a>Uw externe accountant uitnodigen voor uw [!INCLUDE[d365fin](includes/d365fin_md.md)]
...
In de huidige versie van [!INCLUDE[d365fin](includes/d365fin_md.md)] is om uw externe accountant uit te nodigen een beheerder nodig die deze toevoegt aan uw Active Directory-tenant. De stappen hiervoor zijn afhankelijk van het soort rekening in dat u hebt gebruikt toen u zich aanmeldde bij [!INCLUDE[d365fin](includes/d365fin_md.md)]. Dit onderwerp is gebaseerd op het gebruik van een Office 365-account dat Microsoft Azure Active Directory gebruikt.  

> [!TIP]  
>  Het is raadzaam contact met uw [!INCLUDE[d365fin](includes/d365fin_md.md)]-partner op te nemen voor hulp.  
