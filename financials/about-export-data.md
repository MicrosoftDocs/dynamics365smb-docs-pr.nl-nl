---
title: Uw gegevens naar Excel exporteren vanuit Dynamics 365 for Financials | Microsoft Docs
description: Meer informatie over het exporteren van uw gegevens van Dynamics 365 for Financials naar Excel.
...
---
# <a name="exporting-your-data-to-excel-from-dynamics-365-for-financials"></a>Uw gegevens naar Excel exporteren vanuit Dynamics 365 for Financials
...
**Opmerking**: als u meer dan één bedrijf in [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)] hebt ingesteld, moet u de relevante gegevens van elk bedrijf exporteren.

## <a name="see-also"></a>Zie ook
[Uw abonnement voor [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)] annuleren] (madeira-cancel.md)  
