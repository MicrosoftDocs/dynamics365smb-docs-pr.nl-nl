---
title: De extensie GetAddress.io UK Postcodes | Microsoft Docs
description: Levert informatie over de extensie GetAddress.io UK Postcodes
...
1. Kies onder **Adres** de optie **Adres van postcodes opzoeken**.  
    ...
    **OPMERKING:** De optie **Adres van postcodes opzoeken** is alleen beschikbaar als het veld **Land-/regiocode** leeg is of de waarde **GB** bevat.
...
3. Selecteer in het venster **Adresselectie** het adres.  
    ...
    **TIP:** Als u het huisnummer weet, kunt u adressen filteren door enkele of alle nummers in te voeren in het veld **Besteladres**.
